...
#define MAX_ACCOUNTS      10000000UL
...
static void create_snapshot_async(void)
{
    ...
    task->snapshot_state = (Account *)malloc(MAX_ACCOUNTS * sizeof(Account));
    ...
    // Copy current state
    memcpy(task->snapshot_state, g_state, MAX_ACCOUNTS * sizeof(Account));
...
int main(void)
{
    ...
    printf("=== Enhanced Log-Optimized State Management with Memset Support ===\n");
